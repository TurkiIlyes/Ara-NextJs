  ...
  return (
    <div className=" w-full flex gap-4 items-center">
      <div className="flex flex-col gap-2 w-full pt-2 pb-4 px-4 shadow-[0px_0px_2px] shadow-customBlue-800  rounded-md">
        ...
        <div className="relative flex flex-col gap-4 justify-center items-center w-full h-full bg-grayscale-300 border-grayscale-700 border-dashed border-[1px] shadow-[0px_0px_1px] shadow-customBlue-800 rounded-sm">
          <input
            type="file"
