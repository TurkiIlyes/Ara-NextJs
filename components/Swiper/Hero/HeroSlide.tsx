  ...
  return (
    ...
    >
      <div className=" w-full h-full absolute top-[45%] z-10 flex flex-col items-center gap-8">
        ...
        <p className="  max-w-[750px] px-4 text-center text-xl sm:text-2xl md:text-5xl leading-normal md:leading-tight font-semibold md:font-bold text-white capitalize ">
          {slideData.desc}
        </p>
      </div>
    </div>
